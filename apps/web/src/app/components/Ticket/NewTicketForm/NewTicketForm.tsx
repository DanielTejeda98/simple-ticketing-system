          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="md:w-1/2">
                ...
                <FormDescription
                  className={errors?.number?.message ? "text-destructive" : ""}
                >
              ...
              <FormItem className="md:w-1/2">
                ...
                <FormControl>
                  <Select
                    ...
                    onValueChange={(e) =>
                      newTicketForm.setValue("contactType", e)
                    }
                  >
                    <SelectTrigger>
                ...
                <FormDescription
                  className={
                    errors?.contactType?.message ? "text-destructive" : ""
                  }
                >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="md:w-1/2">
                ...
                <FormDescription
                  className={errors?.state?.message ? "text-destructive" : ""}
                >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="md:w-1/2">
                ...
                <FormDescription
                  className={errors?.impact?.message ? "text-destructive" : ""}
                >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="md:w-1/2">
                ...
                <FormDescription
                  className={errors?.urgency?.message ? "text-destructive" : ""}
                >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="md:w-1/2">
                ...
                <FormDescription
                  className={
                    errors?.priority?.message ? "text-destructive" : ""
                  }
                >
