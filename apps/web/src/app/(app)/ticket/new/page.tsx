...
export default async function NewTicketPage () {
    ...
    return (
        <main className="flex flex-col w-full px-4 md:px-8 mt-6 md:mt-[10vh]">
            ...
            <NewTicketForm projects={JSON.parse(JSON.stringify(projects))} resources={JSON.parse(JSON.stringify(retrievedUsers))} ticketTypes={JSON.parse(JSON.stringify(ticketTypes))}/>
        </main>
    )
}