export default function PasswordResetByAdminEmailTemplate (userName: string, password: string): string {
    return `
        <!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="container">
        ...
        <p>Hi ${userName},</p>
        <p>Your password for your Simple Ticketing System account has been reset by an admin.</p>
        <p>Please use this password to log in ${password}. We recommend you change your password after logging in.</p>
